...
$GitHubHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/MCSEdwin/AL-Go-Actions/MXMain/Github-Helper.psm1' -folder $tmpFolder
$ALGoHelperPath = DownloadHelperFile -url 'https://raw.githubusercontent.com/MCSEdwin/AL-Go-Actions/MXMain/AL-Go-Helper.ps1' -folder $tmpFolder
DownloadHelperFile -url 'https://raw.githubusercontent.com/MCSEdwin/AL-Go-Actions/MXMain/Packages.json' -folder $tmpFolder | Out-Null
